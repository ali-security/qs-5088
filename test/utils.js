...
test('combine()', function (t) {
    t.test('both arrays', function (st) {
        var a = [1];
        var b = [2];
        var combined = utils.combine(a, b, 20, false);
    ...
    t.test('one array, one non-array', function (st) {
        ...
        var combinedAnB = utils.combine(aN, b, 20, false);
        ...
        var combinedABn = utils.combine(a, bN, 20, false);
    ...
    t.test('neither is an array', function (st) {
        var combined = utils.combine(1, 2, 20, false);
